/*
 * On chapter 5:
 *    - changing material mesh (e.g. basic, lambert, phong)
 *    - add texture, bumpMap, roughness maps
 *    - add environment Cube maps
 */
function init() {
  ...
  folder3.open(); // start datGui folder open (default: close)

  //    shininess does not exist in standard materials - use roughness
  // folder3.add(sphereMaterial, 'shininess', 0, 1000);
  // folder3.add(planeMaterial, 'shininess', 0, 1000);

  // high shininess - metal
